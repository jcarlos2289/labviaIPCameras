...
class CameraThreadFaceDetection:
    def __init__(self, camera_source, window_name, model_path, output_size_factor=0.5):
        ...
        options = vision.FaceDetectorOptions(
            ...
            # Puedes ajustar el modelo si es necesario (model_selection)
            # model_selection=0 (short-range, para caras a 2m), 1 (full-range, para caras a 5m)
        )
        ...
        # Para FaceDetector, las especificaciones de dibujo por defecto son más sencillas
        # y no dependen de mp.solutions.drawing_styles de la misma manera que pose.
                ...
                for detection in detection_result.detections:
                    ...
                    if detection.keypoints:
                        for kp in detection.keypoints:
                            # Los keypoints vienen normalizados, necesitamos escalarlos a las dimensiones del frame
...
def deteccion_cuatro_camaras_facial_gpu():
    # El modelo de MediaPipe Face Detector. Se descargará automáticamente.
    # Puedes elegir entre 'blaze_face_short_range.tflite' o 'blaze_face_full_range.tflite'
    # para diferentes distancias de detección.
    ...
    for i, source in enumerate(cam_sources):
        thread = CameraThreadFaceDetection( # Usamos la nueva clase para detección facial
